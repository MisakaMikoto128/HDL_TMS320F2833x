...
{
    byte_t ucCRCHi = 0xFF; /* 高CRC字节初始化 */
    byte_t ucCRCLo = 0xFF; /* 低CRC 字节初始化 */
...
{
    byte_t ucCRCHi = crc >> 8; /* 高CRC字节初始化 */
    byte_t ucCRCLo = crc & 0xFF; /* 低CRC 字节初始化 */
    uint16_t usIndex;       /* CRC循环中的索引 */
